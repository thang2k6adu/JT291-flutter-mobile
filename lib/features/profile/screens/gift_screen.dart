      ...
      data: (gifts) {
        if (gifts.isEmpty) {
          return RefreshIndicator(
            ...
            child: ListView(
              controller: _giftWallScrollController,
              children: const [
                SizedBox(height: 200),
                Center(
                  child: Text(
    ...
    return recentGiftsAsync.when(
      data: (transactions) {
        ...
        return RefreshIndicator(
          ...
          child: _buildRecentGiftsList(transactions, notifier),
        );
      },
      loading: () =>
          const Center(child: CircularProgressIndicator(color: Colors.pink)),
        ...
        if (index < transactions.length) {
          return RecentGiftItem(
            ...
            onTap: () {
              ...
              print('Tapped on gift from ${transactions[index].sender.nickname}');
            },
          );
        } else {
          // Loading indicator
