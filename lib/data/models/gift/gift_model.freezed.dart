...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,itemId,name,imageUrl,price,type,isEvent,eventEndDate,description,category,quantity,requiredCount,currentCount);

@override
String toString() {
  return 'GiftModel(id: $id, itemId: $itemId, name: $name, imageUrl: $imageUrl, price: $price, type: $type, isEvent: $isEvent, eventEndDate: $eventEndDate, description: $description, category: $category, quantity: $quantity, requiredCount: $requiredCount, currentCount: $currentCount)';
}
