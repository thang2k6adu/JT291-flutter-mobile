...
// ========================================
@JsonKey(name: 'is_following') bool get isFollowing;@JsonKey(name: 'is_follower') bool get isFollower;@JsonKey(name: 'follow_status') String get followStatus;@JsonKey(name: 'mutual_followers_count') int get mutualFollowersCount;// ========================================
// Status & Flags
// ========================================
...
switch (_that) {
case _UserModel() when $default != null:
return $default(_that.id,_that.unionId,_that.nickname,_that.avatar,_that.bio,_that.gender,_that.birthday,_that.profileUrls,_that.interests,_that.followingCount,_that.followersCount,_that.viewsCount,_that.isFollowing,_that.isFollower,_that.followStatus,_that.mutualFollowersCount,_that.role,_that.isDeleted,_that.isBlocked,_that.isPending,_that.level);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,unionId,nickname,avatar,bio,gender,birthday,const DeepCollectionEquality().hash(_profileUrls),const DeepCollectionEquality().hash(_interests),followingCount,followersCount,viewsCount,isFollowing,isFollower,followStatus,mutualFollowersCount,role,isDeleted,isBlocked,isPending,level]);
