...
final followerMock = UserListResponse(
  ...
  data: List.generate(
    ...
    (i) => UserModel(
      id: "follower_${i + 1}",
      uid: "u_follower_${i + 1}",
      username: _userNames[(i + 5) % _userNames.length],
      nickname: _userNames[(i + 5) % _userNames.length],
      avatarUrl: "https://i.pravatar.cc/150?u=follower_${i + 1}",
      bio: _bios[(i + 3) % _bios.length],
      shortBio: _bios[(i + 3) % _bios.length],
...
final friendMock = UserListResponse(
  ...
  data: List.generate(
    ...
    (i) => UserModel(
      id: "friend_${i + 1}",
      uid: "u_friend_${i + 1}",
      username: _userNames[(i + 10) % _userNames.length],
      nickname: _userNames[(i + 10) % _userNames.length],
      avatarUrl: "https://i.pravatar.cc/150?u=friend_${i + 1}",
      bio: _bios[(i + 5) % _bios.length],
      shortBio: _bios[(i + 5) % _bios.length],
      gender: i.isEven ? "female" : "male",
      isFollowing: true,
      followStatus: "mutual",
      verified: i % 3 == 0,
